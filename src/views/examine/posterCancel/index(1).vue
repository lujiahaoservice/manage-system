            ...
            <div class="vip_main">
              <div class="vip_main_item">
                ...
                <div class="vip_main_item_input">
                  <el-input-number  v-model="money" :min="0" label="请输入扣除金额" size="mini"></el-input-number>
                </div>
              </div>
            </div>
  ...
  methods: {
    ...
    submit() {
      ...
      const data = {
        ...
        cancelStatus: 7,
        executorCancelAmount: this.money * 100
      }
    ...
    changeTab(type) {
      ...
      if (type === '6') {
        ...
        this.posterCancel_time = [fiveAgoToday, today]
      }
      this.initData()
    },
    initData(startTime, endTime) {
      const data = {
        ...
        status: this.status,
        cancelerIdentity: 1,
        startTime: startTime || this.posterCancel_time[0],
        endTime: endTime || this.posterCancel_time[1]
      }
